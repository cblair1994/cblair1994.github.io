...
function removeSelectDefault() {
   var selectBox = document.getElementById("shipping");
...
function validateRequired() {
   ...
   var crustBoxes = document.getElementsByName("cover");
   ...
   try {
      ...
      if (!formatbox[0].checked && !formatbox[1].checked) { 
         // verify that a crust is selected
         formatbox[0].style.outline = "1px solid red";
         formatbox[1].style.outline = "1px solid red";
         fieldsetValidity = false;
      } else {
         formatbox[0].style.outline = "";
         formatbox[1].style.outline = "";
      }
